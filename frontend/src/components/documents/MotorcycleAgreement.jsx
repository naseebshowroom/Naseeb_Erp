...
const MotorcycleAgreement = ({ installment, customer }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ direction: 'rtl', padding: '0 2px' }}>
        {[
          `میں <span class="english-inline">${customerName}</span> ولد <span class="english-inline">${fatherName}</span> اقرار کرتا/کرتی ہوں کہ مجھے مذکورہ موٹر سائیکل چیک اور درست حالت میں وصول ہوا ہے۔`,
          ...
          "میں نے مذکورہ موٹر سائیکل اپنی ذاتی گھریلو ضروریات کیلئے خود اپنی رضامندی سے خریدا ہے۔ میں ہر گز قسط ادائیگی میں کوتاہی یا دھوکہ نہیں کروں گا/گی۔",
          "اگر میری رہائش یا ملازمت کی جگہ تبدیل ہوئی تو دوکان پر نیا ایڈریس دینے کا/کی پابند ہوں۔",
          "اگر میں نے قسط ادا کرنے سے انکار کیا یا ٹال مٹول کیا تو فرم کو حق حاصل ہے کہ وہ موٹر سائیکل واپس لے لے اور ادا شدہ رقم ضبط ہو گی۔",
...
export default MotorcycleAgreement;
